...
fun View.showWithAnimation() {
    ...
    this.slideAnimation(direction = SlideDirection.UP, type = SlideType.SHOW, duration = 500)
}
...
fun View.hideWithAnimation() {
    ...
    this.slideAnimation(direction = SlideDirection.DOWN, type = SlideType.HIDE, duration = 500)
